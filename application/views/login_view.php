...
input:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
  ...
  <h1>Login</h1>
    <form method="post">
   <!-- <center><img src="<?php echo base_url('assets1/login.png') ?>" style="height:150px;width:150px;"></center> -->
                <?php 
                ...
                ?>
                  ...
                  <a href="<?php echo site_url('login/register') ?>" class="btn btn-primary">Signup</a>
                  <?php echo form_close() ?>
                </form>   
</div>
      <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    <script src="<?php echo base_url('assets1/js/index.js') ?>"></script>
